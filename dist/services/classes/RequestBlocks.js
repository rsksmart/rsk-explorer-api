...
async function getBlock(hashOrNumber, { nod3, collections, log, nativeContracts }) {
  ...
  try {
    let newBlock = new _Block.Block(hashOrNumber, { nod3, collections, log, nativeContracts });
