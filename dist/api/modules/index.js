...
var _ExtendedStats = require("./ExtendedStats");
var _ContractVerification = require("./ContractVerification");
var _apiTools = require("../lib/apiTools");

const apiModules = { Block: _Block.Block, Tx: _Tx.Tx, Address: _Address.Address, Event: _Event.Event, Token: _Token.Token, TxPending: _TxPending.TxPending, Stats: _Stats.Stats, Summary: _Summary.Summary, ExtendedStats: _ExtendedStats.ExtendedStats, ContractVerification: _ContractVerification.ContractVerification };
